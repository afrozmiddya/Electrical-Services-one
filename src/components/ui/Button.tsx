...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-primary text-white hover:bg-primary/90 shadow-[0_0_15px_rgba(59,130,246,0.3)] hover:shadow-[0_0_20px_rgba(59,130,246,0.5)] font-semibold',
      ...
      gradient: 'bg-gradient-to-r from-primary to-blue-400 text-white hover:opacity-90 shadow-[0_0_20px_rgba(59,130,246,0.4)] font-semibold',
    };
