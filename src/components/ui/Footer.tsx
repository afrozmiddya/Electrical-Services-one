      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-text-secondary text-sm leading-relaxed">
              Premium electrical contracting services in Kolkata. Residential, commercial, and industrial solutions you can trust. 24/7 emergency support available.
            </p>
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-background flex items-center justify-center text-text-secondary hover:text-primary hover:bg-primary/10 transition-colors border border-border-subtle hover:border-primary/30">
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-3">
              {['Home', 'About Us', 'Projects', 'Reviews', 'FAQ', 'Contact'].map((item) => (
                <li key={item}>
                  <Link
                    to={item === 'Home' ? '/' : `/${item.toLowerCase().replace(' ', '-')}`}
                    className="text-text-secondary hover:text-primary transition-colors flex items-center gap-2 text-sm group"
                  >
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-4">
              <li>
                <a href="tel:8777539391" className="flex items-start gap-3 text-text-secondary hover:text-primary transition-colors group">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="font-semibold text-text-main">8777539391</span>
                  </div>
                </a>
              </li>
              <li>
                <a href="mailto:eservices22@yahoo.com" className="flex items-start gap-3 text-text-secondary hover:text-primary transition-colors group">
                  <div className="w-8 h-8 rounded-lg bg-background flex items-center justify-center border border-border-subtle group-hover:border-primary/30 shrink-0">
                    <Mail className="w-4 h-4 text-primary" />
                  </div>
                  <div className="flex flex-col">
                    <span className="text-sm">Email Us</span>
                    <span className="font-semibold text-text-main text-xs sm:text-sm truncate">eservices22@yahoo.com</span>
                  </div>
                </a>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-border-subtle flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-text-secondary text-sm text-center md:text-left">
            &copy; {currentYear} Electrical Services. All rights reserved.
          </p>
